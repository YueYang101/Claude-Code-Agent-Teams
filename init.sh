...
echo "✓ Copied .claude/agents/ (7 agent personas)"

# Copy skills
rm -rf "$TARGET/.claude/skills"
cp -r "$SCRIPT_DIR/.claude/skills" "$TARGET/.claude/skills"
echo "✓ Copied .claude/skills/ (11 team skills)"
...
echo "  /team-feature-backend    — 6-agent backend feature pipeline"
echo "  /team-feature-fullstack  — 7-agent fullstack feature pipeline"
echo "  /team-bugfix             — Bug fix (backend or fullstack)"
echo "  /team-bugfix-backend     — 5-agent backend bugfix pipeline"
echo "  /team-bugfix-fullstack   — 6-agent fullstack bugfix pipeline"
echo "  /team-quick              — Quick task (backend or fullstack)"
echo "  /team-quick-backend      — 4-agent backend quick task"
echo "  /team-quick-fullstack    — 5-agent fullstack quick task"
